...
const Page = () => {
  ...
  return (
    <div >
      ...
      <div className="relative container m-auto px-6 py-20 text-white md:p-12 xl:px-40">
            ...
            <div className="p-6 sm:p-16">
              <div className="space-y-4">
                ...
                <h2 className="mb-8 text-2xl text-white font-bold">
                  Sign in to unlock the <br /> best of PassOP.
                </h2>
              </div>
              ...
              <div className="mt-12 space-y-4 text-white text-center sm:-mb-8">
                <p className="text-xs">
